...
// Helper function to shuffle options and update correctAnswer index
...
// ========== QUIZ 3: Python Complete Course (70 Questions) ==========
const pythonQuiz = {
...
console.log("✅ Python Quiz Loaded - 70 Questions");

// Shuffle options for Python quiz
pythonQuiz.questions = pythonQuiz.questions.map(shuffleOptions);
console.log("✅ Python Quiz Options Shuffled");
...
const seedDB = async () => {
  try {
    ...
    await Quiz.create([quiz1, quiz2, pythonQuiz]);

    console.log("✅ Quizzes seeded successfully!");
    console.log("📝 Quiz 1 (JavaScript Chapter 1-20): 80 questions");
    console.log("📝 Quiz 2 (JavaScript Chapter 21-40): 3 levels with 120 total questions");
    console.log("📝 Quiz 3 (Python Complete Course): 70 questions");

    console.log("🎯 Grand Total: 270 questions across 3 quizzes");
    process.exit(0);
  } catch (error) {
